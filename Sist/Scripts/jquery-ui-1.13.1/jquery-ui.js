...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		selectMonthLabel: "Selecciona mes", // Invisible label for month selector
		selectYearLabel: "Selecciona año" // Invisible label for year selector
	};
